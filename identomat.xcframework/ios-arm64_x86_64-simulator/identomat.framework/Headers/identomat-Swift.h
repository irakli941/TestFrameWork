...
SWIFT_CLASS("_TtC9identomat19FoundationTransport")
...
SWIFT_CLASS("_TtC9identomat16IdentomatManager")
@interface IdentomatManager : NSObject
...
SWIFT_CLASS("_TtC9identomat12NativeEngine") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
